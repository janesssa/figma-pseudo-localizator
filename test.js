...
//       reverted = true
//       if(Object.keys(nodes).length === 0 || Object.keys(newNodes).length === 0){
//         alert(message)
//       } else {
//         startProgress('revert')
//         stopProgress('start')
//         Object.keys(nodes).forEach(key => {
//           if(nodes[key].characters === newNodes[key].characters){
//             if(!alertOnce){
...
//       stopProgress('revert')
//       stopProgress('start')
//       if(Object.keys(originalNodes).length < 0){
//         figma.closePlugin()
//       } else {
